      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10 w-full">
        ...
        <div className="flex flex-col items-start gap-4 mb-16">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-card/80 border border-card text-xs font-mono font-semibold uppercase tracking-wider text-secondary shadow-sm"
          >
          ...
          <FramerWrapper y={20} x={0} className="w-full">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
              <div className="max-w-2xl space-y-3">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-[1.1] text-primary">
                  A little about   {"  "}
            ...
            <InteractiveTiltCard glowColor={glowColor} className="p-8 sm:p-10 h-full flex flex-col justify-between">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-6 mt-6 border-t border-card">
                <div className="p-3 rounded-2xl bg-main/50 border border-card">
                  <span className="text-[10px] font-mono text-secondary uppercase block">Core Focus</span>
                  <span className="text-xs font-bold text-primary font-mono mt-0.5 block">AI & Full-Stack</span>
                </div>
                <div className="p-3 rounded-2xl bg-main/50 border border-card">
                  <span className="text-[10px] font-mono text-secondary uppercase block">Hackathon Honor</span>
                  <span className="text-xs font-bold text-primary font-mono mt-0.5 block">IIT Guwahati '25</span>
                </div>
                <div className="p-3 rounded-2xl bg-main/50 border border-card col-span-2 sm:col-span-1">
                  <span className="text-[10px] font-mono text-secondary uppercase block">Primary Language</span>
                  <span className="text-xs font-bold text-primary font-mono mt-0.5 block">TypeScript & C++</span>
                </div>
              </div>
            </InteractiveTiltCard>
          </div>
