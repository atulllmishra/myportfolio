...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a0e17] border-t border-[#1e293b] pt-16 pb-12 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-[#1e293b]">
          ...
          <div className="md:col-span-4 space-y-3">
            ...
            <div className="w-full h-32 rounded-lg border border-[#1e293b] overflow-hidden bg-[#131c2e]">
              <iframe
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-slate-500">
          <p>© {new Date().getFullYear()} Atul Kumar Mishra. All rights reserved.</p>
