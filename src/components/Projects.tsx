...
const projectsList: ProjectItem[] = [
  {
    ...
    description: "An online edtech platform that automatically generates AI video solutions for user questions in multiple languages and allows students to dynamically transform lectures into different difficulty levels.",
    highlights: [
      "Generates AI video & voice solutions to questions asked in multiple languages",
      "Dynamic lecture difficulty transformation tailored to learner levels",
      "Personalized adaptive video learning engine with multilingual synthesis"
    ],
    tech: ["Generative AI", "AI Video Synthesis", "Next.js", "TypeScript", "LLMs", "Tailwind CSS"],
  ...
  },
  {
    ...
    timeline: "March 2025",
    description: "Named Finalist at IIT Guwahati ImpactHack Hackathon 2025 in March 2025. An intelligent precision farming decision support platform empowering farmers with real-time city temperature forecasting and live crop market price predictions.",
    highlights: [
