    ...
    <div className="perspective-1000 w-full h-full">
      ...
      >
        ...
        <div className="flex justify-between items-start mb-4" style={{ transform: "translateZ(30px)" }}>
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-main border border-card text-[10px] font-mono font-bold uppercase tracking-wider text-accent">
            <Code2 className="w-3 h-3" />
            <span>{project.categoryLabel}</span>
          </div>
          <div className="text-xs font-mono text-secondary font-medium px-2 py-1 bg-main rounded-md border border-card">
            {project.timeline}
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-6" style={{ transform: "translateZ(25px)" }}>
          {project.tech.map((t, i) => (
            <span key={i} className="px-2.5 py-1 text-[11px] font-mono font-medium rounded-md bg-main border border-card text-primary">
              {t}
            </span>
          ))}
        </div>
        ...
        <div className="pt-4 mt-auto border-t border-card flex items-center justify-between" style={{ transform: "translateZ(35px)" }}>
          ...
          <div className="text-[11px] font-mono font-bold tracking-wider uppercase flex items-center gap-1 text-accent transition-transform group-hover:translate-x-1" style={{ color: accentColor }}>
            <span>Examine</span>
